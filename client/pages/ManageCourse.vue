    ...
    <div class="flex justify-center items-center w-full pt-8 mt-8">
      ...
      <form class="w-7/12">
        ...
        <div class="relative mx-2">
          ...
          <button
            type="submit"
            class="text-white absolute right-2.5 bottom-2.5 bg-[#2B26D8] hover:bg-[#130ec7] focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-3xl text-sm px-4 py-2"
          >
            Search
          </button>
        </div>
