        ...
        <div class="w-[90%]">
          <div class="flex justify-between">
            <div class="flex justify-center items-center space-x-10">
              <div class="w-[200px] h-[200px] border border-white border-[5px] rounded-full overflow-hidden drop-shadow-md">
                <img src="https://cdn.discordapp.com/attachments/1067453596351856650/1095743639998705895/IMG_2726.jpg" alt="">
              </div>
          ...
          <div class="space-y-5 mt-16">
            <div class="flex">
              ...
              <input class="border rounded px-3 py-1 w-[30%]" type="text">
            </div>
